...
- **Accesibilidad:** axe sin violaciones; CTA semántico, foco compartido visible, alt obligatorio, movimiento reducido y tamaño táctil verificados.
...
Se limitó el tracking negativo desde tokens, se eliminó la duplicación del tagline y se retiró el hover sobre una imagen no interactiva. El caption vive debajo de la fotografía, sin cubrir el asset ni simular una etiqueta flotante. La jerarquía mantiene una única acción primaria y una firma visual gobernada por theme. La posición inicial o final de la imagen se modela como prop: cambia la composición, no el propósito ni la estructura del módulo.
