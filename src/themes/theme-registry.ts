...
const themeDefinitions = themeRegistrySchema.parse([
  {
    ...
    tokens: {
      colors: {
        ...
        onAccent: "#fffaf4",
        onSignal: "#261d1f",
        inverseSurface: "#261d1f",
        onInverse: "#fffaf4",
        onInverseMuted: "#ded2d3",
        inverseLine: "#66565a",
        mediaScrim: "#171012",
        onMedia: "#fffaf4",
        focus: "#7a334d",
  ...
  },
  {
    ...
    tokens: {
      colors: {
        ...
        onAccent: "#fffaf8",
        onSignal: "#2c2025",
        inverseSurface: "#2c2025",
        onInverse: "#fffaf8",
        onInverseMuted: "#dfd0d5",
        inverseLine: "#6a555e",
        mediaScrim: "#1b1115",
        onMedia: "#fffaf8",
        focus: "#8d405d",
  ...
  },
  {
    ...
    tokens: {
      colors: {
        ...
        onAccent: "#fbf6ec",
        onSignal: "#1e1c18",
        inverseSurface: "#1e1c18",
        onInverse: "#fbf6ec",
        onInverseMuted: "#d2c9b9",
        inverseLine: "#5f594e",
        mediaScrim: "#14120f",
        onMedia: "#fbf6ec",
        focus: "#914631",
  ...
  },
  {
    ...
    tokens: {
      colors: {
        ...
        onAccent: "#ffffff",
        onSignal: "#11130f",
        inverseSurface: "#11130f",
        onInverse: "#ffffff",
        onInverseMuted: "#cbd0c6",
        inverseLine: "#51594c",
        mediaScrim: "#0c0e0b",
        onMedia: "#ffffff",
        focus: "#1733b6",
...
export const themeCssVariables = (theme: Theme): Record<string, string> => ({
  ...
  "--theme-color-inverse-surface": theme.tokens.colors.inverseSurface,
  "--theme-color-on-inverse": theme.tokens.colors.onInverse,
  "--theme-color-on-inverse-muted": theme.tokens.colors.onInverseMuted,
  "--theme-color-inverse-line": theme.tokens.colors.inverseLine,
  "--theme-color-media-scrim": theme.tokens.colors.mediaScrim,
